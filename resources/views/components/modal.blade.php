@props(['title','body','cancel'=>'cancel','activate'=>'activate','show'=>0])

<div class="fixed z-10 inset-0 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true" x-data="data()"
